...
class Ffuenf_MageTrashApp_Helper_Data extends Ffuenf_Common_Helper_Core
{
    const CONFIG_EXTENSION_ACTIVE = 'ffuenf_magetrashapp/general/enable';
    const DISABLE = 0;
    const ENABLE = 1;
    const UNINSTALL = 2;
    const DELETE = 0;
    ...
    public function uninstallModule($moduleName)
    {
        ...
        /* @var $uninstallModel Ffuenf_MageTrashApp_Model_Uninstall */
